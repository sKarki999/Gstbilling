...
<body data-layout-mode="detached" data-layout='{"mode": "light", "width": "fluid", "menuPosition": "fixed", "sidebar": { "color": "light", "size": "default", "showuser": true}, "topbar": {"color": "dark"}, "showRightSidebarOnPageLoad": true}'>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row my-3">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input required type="text" value="" name="fullname" class="form-control border-bottom" id="validationCustom01" placeholder="Enter Full Name">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="">Phone Number</label>
                                                <input required type="text" value=""  name="phone_number" class="form-control border-bottom" id="validationCustom01" placeholder="Enter Phone/Mobile no.">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="">Address</label>
                                                <input required type="text" value=""  name="address" class="form-control border-bottom" id="validationCustom02" placeholder="Enter Address">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="">Invoice Number *</label>
                                                <input required type="text" value="" name="invoice_number" class="form-control border-bottom">
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="">Invoice Date *</label>
                                                <input required type="date" value="" name="invoice_date" class="form-control border-bottom" id="validationCustom01">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row my-3">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input required type="text" value=""  name="account_holder_name" class="form-control border-bottom" id="validationCustom01" placeholder="Enter Account Holder Name">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="">Account Number</label>
                                                <input required type="text" value=""  name="account_number" class="form-control border-bottom" id="validationCustom01" placeholder="Enter Account Number">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="">Bank Name</label>
                                                <input required type="text" value=""  name="bank_name" class="form-control border-bottom" id="validationCustom02" placeholder="Enter Bank Name">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input required type="text" value=""  name="ifsc_code" class="form-control border-bottom" id="validationCustom01" placeholder="Enter IFSC Code">

                                            </div>
                                            <div class="form-group col-md-9">
                                                <label for="">Branch Address</label>
                                                <input required type="text" value=""  name="branch_address" class="form-control border-bottom" id="validationCustom01" placeholder="Enter Address">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-8 border p-2">
                                                <textarea class="form-control" required name="item_description" placeholder="Enter work details (hit enter for new line)" rows="5">{{ old('item_description') }}</textarea>
                                            </div>
                                            <div class="col-md-4 border p-2">
                                                <input class="form-control" required type="text" value="{{ old('total_amount') }}" name="total_amount" id="totalInput" oninput="displayTotalAmount()">
                                            </div>
                                        </div>
    ...
    <script src="{{asset("assets/js/tax.js")}}"></script>
</body>
