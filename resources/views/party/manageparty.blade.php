            ...
            <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100 table-bordered"
                ...
                <tbody>
                    @if (count($parties))
                        ...
                        <tr>
                            <td><b>{{ $index + 1}}</b></td>
                            <td><b> <span class="badge badge-warning"> {{ $party->party_type}} </span></b></td>
                            <td>
                                <ul class="list-unstyled">
                                    <li><b>Name :</b><span> {{$party->fullname}}</span></li>
                                    <li><b>Phone :</b><span> {{$party->phone_number}}</span></li>
                            ...
                            <td>
                                <ul class="list-unstyled">
                                    <li><b>Account Holder :</b><span> {{$party->account_holder_name}}</span></li>
                                    <li><b>Acc No :</b><span> {{$party->account_number}}</span></li>
                            ...
                            <td>
                                {{ date("Y-m-d", strtotime($party->created_at))}}
                            </td>
                            ...
                            <td>
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        {{-- <a class="dropdown-item" href="{{route('delete-party', $party->id)}}"><i
